 ...
 const [users, setUsers] = useState([]);
  ...
  useEffect(() => {
    const fetchUser = async () => {
      ...
      try {
        const response = await fetch(`http://localhost:8082/employee/allemp`, {
          headers: {
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
          ...
          {users.map((user, index) => (
            ...
            >
              ...
              {/* <p className="text-gray-800 font-semibold">create:s {user.client_id}</p> */}
...
export default Super_Admin_All_User